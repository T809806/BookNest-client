...
const Categories = () => {
 ...
 <section className="py-20 bg-white">
   ...
   <h2 className="text-center text-4xl font-bold text-emerald-700"> Browse by Categories </h2>
    <p className="mt-4 text-center text-gray-600"> Choose your favorite category and discover amazing books. </p>
